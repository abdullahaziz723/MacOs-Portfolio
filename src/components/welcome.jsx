...
const Welcome = () => {
  ...
  return <section  id="welcome">
    ...
    <p ref={subTitleRef}>{renderText("Hey, I am Abdullah! Welcome to my ", 'text-3xl font-georama',100)}</p>
    <h1 ref={titleRef}  className="mt-7">{renderText("Portfolio", 'text-9xl  italic font-georama')}</h1>

    <div className="small-screen" >
        <p>This Portfolio is designed to for desktop/tablet screens only.</p>
    </div>
  </section>;
};
